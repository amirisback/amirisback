function getReadme() {
    ...
    const imageA8 = '<img id="imageB" width="98px" height="140px" align="right" src="https://amirisback.github.io/amirisback/docs/image/bear-panda/bear-jalan.gif">';
    ...
    const imageB7 = '<img id="imageA" width="85px" height="138px " align="right" src="https://amirisback.github.io/amirisback/docs/image/bear-panda/panda-ngambul.gif">';
    const imageB8 = '<img id="imageA" width="85px" height="140px" align="right" src="https://amirisback.github.io/amirisback/docs/image/bear-panda/panda-jalan.gif">';
